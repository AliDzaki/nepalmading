...
<body class="bg-sky-50">
    <div class="flex justify-center  relative ">
        ...
        <div
            ...
            <form action="/admin/kategori/tambah/store" method="POST">
                @csrf
                <div class="mb-4">
                    ...
                    <p class="text-base text-center font-sans text-slate-500"
                        style="font-family: 'Reddit-sans',sans-serif;">Tambahkan kategori dengan baik dan benar!</p>
                </div>
                ...
                <div>
                    <div class="flex flex-col mb-3">
                        ...
                        @enderror" type="text"
                            name="id_kategori" id="idKategori" value="{{ old('id_kategori') }}">
                            @error('id_kategori')
